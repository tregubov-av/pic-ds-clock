...
#define S1INI 10 //Инициализация счетчика антидребезга для кнопки SELECT.
#define S2INI 10 //Инициализация счетчика антидребезга для кнопки SET.
#define S3INI 10 //Инициализация счетчика антидребезга для второго состояния кнопки SELECT.
